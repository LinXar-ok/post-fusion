...
export default function LoginPage() {
  return (
    <div className="flex min-h-screen bg-white text-slate-900 relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] left-[-5%] w-[40%] h-[40%] rounded-full bg-violet-200/50 blur-[100px] pointer-events-none" />
      ...
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24 z-10 w-full lg:w-[500px] mx-auto bg-white/80 backdrop-blur-xl border-r border-slate-100">
        ...
        >
          <div className="flex items-center mb-10">
            <div className="bg-violet-100 p-2.5 rounded-xl border border-violet-200 shadow-sm flex items-center justify-center">
          ...
          <form action={login} className="space-y-5">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                required
                className="bg-white border-slate-200 text-slate-900 focus-visible:ring-violet-500 rounded-lg h-11 px-4 shadow-sm hover:border-slate-300 transition-colors"
              />
            </div>
            <div className="space-y-1.5">
            ...
            <Button
              type="submit"
              className="w-full h-11 mt-2 rounded-lg bg-slate-900 hover:bg-slate-800 text-white font-medium text-base transition-all group shadow-md"
            >
              Sign In
      ...
      {/* Right side visual panel - Editorial Minimalist style */}
      <div className="hidden lg:block relative w-full flex-1 bg-slate-50 overflow-hidden">
        ...
        {/* Placeholder for an abstract feature image or gradient art */}
